const info = {
  aboutme: {
    title: 'About Me',
    points: [
      'Result-driven Solution Architect with extensive knowledge and 12 years of experience in design, development and maintenance of highly scalable and resilient cloud-native IT solutions.',
      'Proven track record of supporting clients in the adoption of digital technologies to transform Core Business capabilities.',
      'Spearheaded projects to replace Legacy COTs applications with Domain-Driven microservices to provide agility in delivering Business value for customers.',
      'Expertise in design and development of applications using the Twelve-Factor app methodology.',
      'Working experience in designing loosely coupled event-driven applications and also CQRS based eventually consistent applications.',
      'Developed web applications using Java, J2EE Technologies, Spring, Hibernate, Spring Boot, HTML & CSS.',
      'Hands-on full stack development experience using MERN stack.',
      'Experience on DevOps tools like Jenkins, Ansible, GitLab, AWS CDK, CloudFormation, Terraform, Artifactory, Nexus, Atlassian Products',
      'Experience in both relational and non-relational databases, in addition to a variety of caching technologies.'
    ]
  },
  projects: [
    {
      title:
        'Developer at UK Central Goverment Department (Mar 2012 - Dec 2015)',
      tools:
